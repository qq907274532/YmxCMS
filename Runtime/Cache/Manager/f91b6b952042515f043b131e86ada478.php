                           ...
                           <div class="col-md-6 col-md-offset-3" style="margin-top:130px;">
                            <div class="login-panel  panel panel-primary">
                                ...
                                <div class="form-group" style="height:200px;width:400px;overflow:hidden">
                                    ...
                                    <div class="success" style="font-family: 微软雅黑;margin-left:150px;line-height:8"><img  src="/Public/admin/img/error.gif"><span style="margin-left:20px;font-size:16px"><?php echo ($error); ?></span></div>
