										...
										<div class="col-sm-3" style="margin-left:-24px;">
											...
											<select   class="form-control"  style="width:110px" name="group_id" id="pid">
												<option value="0">请选择分类</option>
												 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["username"]); ?>"<?php if($_GET['group_id']== $v['username']): ?>selected=selected<?php endif; ?>><?php echo ($v["username"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
												 ...
												 <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<a onclick="if(confirm('确认要删除吗?')) location.href='<?php echo U('LoginLog/del',array('id'=>$v[id]));?>'"  href="javascript:;"  class="btn btn-xs btn-danger">
