				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							...
							<a class="label label-xlg label-primary arrowed-right " href="<?php echo U('Nav/add');?>">
							添加导航栏</a>
									...
									<div class="col-xs-12">
										<div class="table-responsive">
											...
											<?php if(is_array($list)): foreach($list as $key=>$val): ?><tr >
								                      ...
								                      <td >
								                          <span style="font-size:16px;"><?php echo ($val["name"]); ?> </span>
								                      </td>
								                      <th>
								                      	
								                      	<?php if($val["status"] == '1'): ?><span class="label label-success arrowed">显示</span>
								                      	<?php else: ?>
								                      	<span class="label label-danger arrowed">不显示</span><?php endif; ?>
								                      </th>
								                      <td>
								                        <a href="<?php echo U('Nav/edit',array('id'=>$val['id']));?>" >修改</a>|
								                         <a href="<?php echo U('Nav/del',array('id'=>$val['id']));?>" >删除</a>
								                       </td>
						                      </tr>
						                        <?php if(is_array($val["child"])): foreach($val["child"] as $key=>$va): ?><tr >
					                                ...
					                                <td>
					                                <span style="font-size:15px;">&nbsp;└─<?php echo ($va["name"]); ?></span>
					                                </td>
					                                <td>
					                                <?php if($va["status"] == '1'): ?><span class="label label-success arrowed">显示</span>
								                      	<?php else: ?>
								                      	<span class="label label-danger arrowed">不显示</span><?php endif; ?>
								                    </td>    
					                               <td>
					                                <a href="<?php echo U('Nav/edit',array('id'=>$va['id']));?>" >修改</a>|
					                                 <a href="<?php echo U('Nav/del',array('id'=>$va['id']));?>" >删除</a>
					                               </td>
					                            </tr> 
							                            <?php if(is_array($va["child"])): foreach($va["child"] as $key=>$v): ?><tr  >
							                              <td ><span class="label label-inverse"><?php echo ($v["id"]); ?></span></td>
							                                <td>
							                                   <span style="font-size:15px;">&nbsp;&nbsp;└─<?php echo ($v["name"]); ?></span>
							                                </td>
							                                 <td>
					                                <?php if($v["status"] == '1'): ?><span class="label label-success arrowed">显示</span>
								                      	...
								                      	<span class="label label-danger arrowed">不显示</span><?php endif; ?>
							                                ...
							                                <td>
							                                <a href="<?php echo U('Nav/edit',array('id'=>$v['id']));?>" >修改</a>|
							                                 <a href="<?php echo U('Nav/del',array('id'=>$v['id']));?>" >删除</a>
							                               </td>
