					...
					<div style="height:50px;" class="page-header">
						<form action="" method="get">
							...
							<span class="input-icon input-icon-right">
								...
								<input style="float:right;" class=" btn-lg btn-success btn btn-xs btn-danger" type="submit" value="搜索">
							</div>
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												 <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
														...
														<td width="30">
															<?php if($v["avatar"] == ''): ?><img style="width:30px;height:30px;"src="/Public/admin/img/1399.png">
															<?php else: ?>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<a onclick="if(confirm('确认要启用吗?')) location.href='<?php echo U('User/enable',array('id'=>$v[id]));?>'"  href="javascript:;"  class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a onclick="if(confirm('确认要禁用吗?')) location.href='<?php echo U('User/shield',array('id'=>$v[id]));?>'"  href="javascript:;"  class="btn btn-xs btn-danger">
