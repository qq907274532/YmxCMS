								 ...
								 <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
										<label>
											<input name="status" type="radio" class="ace" <?php if($info["status"] == 1): ?>checked=checked<?php endif; ?>value="1" />
											<span class="lbl">&nbsp;正常</span>
										</label>
										<label>	
											<input name="status" type="radio" <?php if($info["status"] == 0): ?>checked=checked<?php endif; ?> class="ace" value="1" />
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <label class="checkbox-inline">
												<input   type="checkbox" class="ace" <?php if($info["type"] == 1): ?>checked=checked<?php endif; ?>style="margin-left: 20px;"name="type"/>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
										<label>
											<input name="menu" type="radio" class="ace" <?php if($info["menu"] == 1): ?>checked=checked<?php endif; ?> value="1" />
											<span class="lbl">&nbsp;是</span>
										</label>
										&nbsp;
										<label>
											<input name="menu" type="radio" <?php if($info["menu"] == 0): ?>checked=checked<?php endif; ?> class="ace" value="0" />
