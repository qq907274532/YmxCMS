						...
						<div class="page-header">
						 <form action="" method="get">
										...
										<span class="input-icon input-icon-right" style="margin-left:-107px;">
											...
											<span class="input-icon input-icon-right">
											<input  type="text" id="title" placeholder="标题" name="title" style="height:32px;" value="<?php echo ($_GET['title']); ?>">
											</span>
											<input  class=" btn-lg btn-success btn btn-xs btn-danger" type="submit" value="搜索">
										</div>
										<a class="label label-xlg label-primary arrowed-right pull-right " href="<?php echo U('Article/add');?>">
							添加文章</a>
												 ...
												 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<a href="<?php echo U('Article/edit',array('id'=>$v['id']));?>" class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a onclick="if(confirm('确认删除?')) location.href='<?php echo U('Article/del',array('id'=>$v[id]));?>'"  href="javascript:;"  class="btn btn-xs btn-danger">
