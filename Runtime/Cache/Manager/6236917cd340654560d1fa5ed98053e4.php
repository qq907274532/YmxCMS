							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="" method="post" id="myform"  >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="title" placeholder="公司名称" class="col-sm-4" name="name"  value="<?php echo ($info["name"]); ?>" />
									...
									<div class="form-group">
										...
										<div class=" col-xs-12 col-sm-4">
											<textarea class="form-control" rows="4" name="desc" id="descs" placeholder="描述"><?php echo ($info["desc"]); ?></textarea>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="url" placeholder="http://" class="col-sm-4" name="url"  value="<?php echo ($info["url"]); ?>" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="sort" placeholder="排序" class="col-sm-4" name="sort"  value="<?php echo ($info["sort"]); ?>" />
