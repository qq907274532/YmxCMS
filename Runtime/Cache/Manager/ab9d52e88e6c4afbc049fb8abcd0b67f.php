				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							...
							<a class="label label-xlg label-primary arrowed-right " href="<?php echo U('Admin/add');?>">
							添加管理员</a>
													   ...
													   <?php if($v["logintime"] == ''): else: ?>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<a href="<?php echo U('Admin/edit',array('id'=>$v['id']));?>" class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a onclick="if(confirm('确认删除?')) location.href='<?php echo U('Admin/del',array('id'=>$v[id]));?>'"  href="javascript:;" class="btn btn-xs btn-danger">
