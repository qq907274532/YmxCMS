												 ...
												 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<a  onclick="if(confirm('确认要恢复吗?')) location.href='<?php echo U('Recycle/restore',array('id'=>$v[id]));?>'"  href="javascript:;"  class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>
																
																<a onclick="if(confirm('确认要清空吗?')) location.href='<?php echo U('Recycle/del',array('id'=>$v[id]));?>'"  href="javascript:;"  class="btn btn-xs btn-danger">
