				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							...
							<a class="label label-xlg label-primary arrowed-right " href="<?php echo U('AdPos/add');?>">
							添加广告位</a>
												 ...
												 <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<a href="<?php echo U('AdPos/edit',array('id'=>$v['id']));?>" class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a onclick="if(confirm('确认删除?')) location.href='<?php echo U('AdPos/del',array('id'=>$v[id]));?>'"  href="javascript:;" class="btn btn-xs btn-danger">
