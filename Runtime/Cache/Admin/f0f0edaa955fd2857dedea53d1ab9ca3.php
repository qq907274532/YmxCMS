...
<html lang="en">
	<head>
		...
		<script charset="utf-8" src="/Public/admin/layer/layer.js"></script>
												...
												<fieldset>
													...
													<label class="block clearfix">
														...
														<i class="icon-picture"></i>
															<input type="text" class="form-control" style="width:145px;display: inline" placeholder="验证码" name="verify" id="verifys"  />
